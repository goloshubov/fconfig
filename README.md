...
└── host
    └── <hostname>
     ...
        └── home
```
The etc/* and home/* dirs will be recursively copied (or templated if it's .j2 file) with /etc/* and ~/* dirs on an appropriate destination host according to its inventory host and group names.\
