# fconfig
fconfig is my ansible implementation of dotfiles sync scripts. It helps me avoiding configuration drifts on a bunch of fedora linux workstations and (homelab) servers.
